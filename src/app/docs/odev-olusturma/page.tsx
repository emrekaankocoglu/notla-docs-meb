...
export default function OdevOlusturmaPage() {
  return (
    <DocPage title="1. Ödev oluştur" tableOfContents={tableOfContents}>
      <p className="lead">
        Akış, ilgili dersin içinde yeni bir ödev/sınav oluşturarak başlar.
        Bu kayıt daha sonra taslak, öğrenci taramaları, otomatik değerlendirme
        ve sonuç sayfalarını birbirine bağlar.
      </p>
      ...
      >
        <ul>
          ...
          <li>
            <strong>Açıklama</strong> alanına sınav tarihi, ünite adı veya
            kısa not gibi ayırt edici bir bilgi yazabilirsiniz.
          </li>
          <li>
            <strong>Derse kayıtlı tüm öğrencilere ata</strong> anahtarı
            açıksa sınıftaki tüm öğrenciler için gönderim kayıtları otomatik
            hazırlanır.
          </li>
          <li>
