  ...
  return (
    ...
    >
      <p className="lead">
        ...
        çalıştırın. Genellikle tüm soruları seçip varsayılan ayarlarla başlamak
        yeterlidir.
      </p>
      ...
      >
        <ul>
          ...
          <li>
            Sağ üstteki <strong>Otomatik Notlandırma</strong> bağlantısından AI
            çalıştırma ekranına geçilir.
          </li>
        </ul>
      </ScreenSection>
