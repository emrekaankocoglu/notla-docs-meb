    ...
    <DocPage title="6. Sonuçları gör" tableOfContents={tableOfContents}>
      ...
      >
        <ul>
          ...
          <li>
            <strong>Ödev/sınav ortalaması</strong> (kesik yeşil çizgi) tüm
            sorular boyunca sınıf genel ortalamasıdır.
          </li>
          <li>
            Beş özet kutu (En Düşük, Ortanca, En Yüksek, Ortalama, Std Sapma)
            sınıf dağılımını rakamla özetler.
          </li>
          <li>
            Sağ üstteki <strong>Notları CSV&apos;ye Aktar</strong> ve{' '}
            <strong>Notlandırılmış PDF&apos;leri Dışa Aktar</strong> düğmeleri
