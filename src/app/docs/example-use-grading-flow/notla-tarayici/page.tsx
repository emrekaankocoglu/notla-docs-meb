  ...
  return (
    ...
    >
      ...
      <section className="scroll-mt-28">
        ...
        <p>
          Kağıtlar fiziksel olarak elinizdeyse ve hızlıca sınıf yığını taramak
          istiyorsanız mobil uygulama daha pratiktir. Aynı hesapla giriş
          yaparsınız; uygulamada gördüğünüz ders ve ödev/sınavlar web
